...
class Message:
    def __init__(self, selector, sock, addr, def_regeon):
        ...
        self.img = "./image.png"
        #size = pg.size()
        self.regeon = self.regeon = def_regeon
    ...
    def _create_response_json_content(self):
        ...
        if action == "getText":
          #  query = self.request.get("value")
            answer = self._get_text()#request_search.get(query) or f"No match for '{query}'."
            content = {"text": answer}

        elif action == "getClipboard":
            answer = self._get_clipboard()#request_search.get(query) or f"No match for '{query}'."
            content = {"text": answer}
